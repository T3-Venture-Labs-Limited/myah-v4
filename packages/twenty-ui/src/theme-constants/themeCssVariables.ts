...
export const themeCssVariables = {
  ...
  brand: {
    solid: 'var(--t-brand-solid)',
    onSolid: 'var(--t-brand-on-solid)',
    onSolidMuted: 'var(--t-brand-on-solid-muted)',
    solidHover: 'var(--t-brand-solid-hover)',
    solidActive: 'var(--t-brand-solid-active)',
    text: 'var(--t-brand-text)',
    border: 'var(--t-brand-border)',
    soft: 'var(--t-brand-soft)',
    softHover: 'var(--t-brand-soft-hover)',
    softActive: 'var(--t-brand-soft-active)',
    disabled: 'var(--t-brand-disabled)',
    focusRing: 'var(--t-brand-focus-ring)',
    focusHalo: 'var(--t-brand-focus-halo)',
  },
  background: {
