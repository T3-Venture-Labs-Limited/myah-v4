...
@RegisteredWorkspaceCommand('2.20.0', 1789313971535)
@Command({
  name: 'upgrade:2-20:synchronize-campaign-lifecycle-status-metadata',
  description: 'Make Campaign lifecycle status non-editable in existing workspaces',
})
export class SynchronizeCampaignLifecycleStatusMetadataCommand extends ActiveOrSuspendedWorkspaceCommandRunner {
  constructor(
