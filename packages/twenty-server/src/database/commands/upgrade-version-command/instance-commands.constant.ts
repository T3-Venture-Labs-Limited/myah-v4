...
import { CreateManagedProviderFundingActionFastInstanceCommand } from './2-20/2-20-instance-command-fast-1784266302003-create-managed-provider-funding-action';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateInstagramReplyAuditFastInstanceCommand,
