...
import { CreateMyahPlatformOperationFastInstanceCommand } from 'src/database/commands/upgrade-version-command/2-19/2-19-instance-command-fast-1784006887685-create-myah-platform-operation';
...
export const INSTANCE_COMMANDS = [
  ...
  CreateMyahPlatformOperationFastInstanceCommand,
];
