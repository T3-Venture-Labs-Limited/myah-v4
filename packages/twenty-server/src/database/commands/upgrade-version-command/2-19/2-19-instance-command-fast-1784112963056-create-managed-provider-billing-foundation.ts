  ...
  implements FastInstanceCommand
{
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      'ALTER TABLE "core"."managedProviderOperation" ADD "maximumMetronomeProperties" jsonb NOT NULL',
    );
    await queryRunner.query(
      'ALTER TABLE "core"."managedProviderOperation" ADD "actualMetronomeProperties" jsonb',
    );
    await queryRunner.query(
