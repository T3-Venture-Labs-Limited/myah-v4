...
const EXPECTED_VIEW_FIELD_GROUPS = [
] as const;
...
const EXPECTED_PERMISSION_FLAGS = [
] as const;
...
const EXPECTED_COMMAND_MENU = [
] as const;

const expectedByMap = {
  flatObjectMetadataMaps: EXPECTED_OBJECTS, flatFieldMetadataMaps: EXPECTED_FIELDS, flatIndexMaps: EXPECTED_INDEXES, flatSearchFieldMetadataMaps: EXPECTED_SEARCH_FIELDS, flatViewMaps: EXPECTED_VIEWS, flatViewGroupMaps: EXPECTED_VIEW_GROUPS, flatViewFilterMaps: EXPECTED_VIEW_FILTERS, flatViewFieldGroupMaps: EXPECTED_VIEW_FIELD_GROUPS, flatViewFieldMaps: EXPECTED_VIEW_FIELDS, flatRoleMetadataMaps: EXPECTED_ROLES, flatPermissionFlagMaps: EXPECTED_PERMISSION_FLAGS, flatAgentMaps: EXPECTED_AGENTS, flatSkillMaps: EXPECTED_SKILLS, flatPageLayoutMaps: EXPECTED_PAGE_LAYOUTS, flatPageLayoutTabMaps: EXPECTED_PAGE_LAYOUT_TABS, flatPageLayoutWidgetMaps: EXPECTED_PAGE_LAYOUT_WIDGETS, flatNavigationMenuItemMaps: EXPECTED_NAVIGATION, flatCommandMenuItemMaps: EXPECTED_COMMAND_MENU,
} as const;

type RelationContract = readonly [sourceField: string, sourceObject: string, targetObject: string, targetField: string];
const RELATIONS: readonly RelationContract[] = [
  ['0bbf483c-9c52-4286-9427-a14058456611', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '62f3e27e-3c6c-4449-9d81-2b24501f5e3f'],
  ['62f3e27e-3c6c-4449-9d81-2b24501f5e3f', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', '0bbf483c-9c52-4286-9427-a14058456611'],
  ['776301dc-08a6-4692-b9b8-f427f040085b', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '94d2f0e6-0915-40e3-bc40-b1a6336dc16a'],
  ['94d2f0e6-0915-40e3-bc40-b1a6336dc16a', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', '776301dc-08a6-4692-b9b8-f427f040085b'],
  ['3cb59cb6-8ef0-4608-bc1a-872e888a60ed', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '93ed2052-7d48-4a60-b43f-f0a07ccdf1ff'],
  ['93ed2052-7d48-4a60-b43f-f0a07ccdf1ff', 'f99ff6bc-3b56-4600-beb3-cfc2c23364f6', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', '3cb59cb6-8ef0-4608-bc1a-872e888a60ed'],
  ['4fd149a3-b506-45f8-94c4-970a3106eccf', '6a8289d7-8034-4f70-b3fa-47bc0e52828f', 'facac4a1-0a2f-469f-9f1f-81ef01f06578', 'da4861d8-2d29-498d-8a70-62461022dbfd'],
  ['9fd2575c-ca82-59bb-8f10-4907b104e6cb', 'c25bfef3-4636-5864-a777-705238c91326', '0446497e-3240-5a78-a02f-e08594e5c2af', '79efc6cb-48f5-5569-9759-255825e287e0'],
  ['d68a67a8-b5b3-5dd0-a1a5-82ed7561eb4e', 'c25bfef3-4636-5864-a777-705238c91326', 'b4459926-2c01-560a-8432-fa1974168439', 'e9b9d246-f49e-5200-9819-0a4c9cd0d19a'],
  ['e9b9d246-f49e-5200-9819-0a4c9cd0d19a', 'b4459926-2c01-560a-8432-fa1974168439', 'c25bfef3-4636-5864-a777-70527fb00ddd', 'd68a67a8-b5b3-5dd0-a1a5-82ed7561eb4e'],
  ['809800a3-fa41-591e-8d4e-7e9fd0daf322', '843aa6c8-36af-5906-8241-4017c4188df7', 'fd8a37b8-72db-5069-902a-a1763ddc63f7', '00c95791-84b2-50cc-89aa-68faf18011eb'],
  ['3b9494ff-0fe7-5492-8b69-c515f79ea437', '5ca82f72-9778-4ae1-8a8e-9b762c4ce0de', 'f9f0d7a8-7e05-519b-b158-5f543f7a7e9a', '730b323f-fae3-57e2-8e2e-62963106850a'],
  ['e9b9d246-f49e-5200-9819-0a4c9cd0d19a', 'f9f0d7a8-7e05-519b-b158-5f543f7a7e9a', 'b4459926-2c01-560a-8432-fa1974168439', '64617f40-1f95-54cf-be64-ff57c72df280'],
  ['64617f40-1f95-54cf-be64-ff57c72df280', 'b4459926-2c01-560a-8432-fa1974168439', 'f9f0d7a8-7e05-519b-b158-5f543f7a7e9a', 'e9b9d246-f49e-5200-9819-0a4c9cd0d19a'],
];

describe('Myah standard metadata contract', () => {
  it('matches each canonical category exactly and keeps IDs out of other maps', () => {
    const categories = Object.entries(expectedByMap) as [keyof typeof expectedByMap, readonly string[]][];
    const myahIds = new Set(categories.flatMap(([, ids]) => ids));
    for (const [mapName, expected] of categories) {
      const actual = Object.keys(result.allFlatEntityMaps[mapName].byUniversalIdentifier).filter((id) => myahIds.has(id)).sort();
      expect(actual).toEqual([...expected].sort());
      for (const id of expected) {
        for (const [otherName] of categories) if (otherName !== mapName) expect(result.allFlatEntityMaps[otherName].byUniversalIdentifier[id]).toBeUndefined();
      }
    }
  });
  it('asserts every canonical relation endpoint', () => {
    const fields = result.allFlatEntityMaps.flatFieldMetadataMaps.byUniversalIdentifier;
    for (const [sourceField, sourceObject, targetObject, targetField] of RELATIONS) {
      expect(fields[sourceField]).toMatchObject({ objectMetadataUniversalIdentifier: sourceObject, relationTargetObjectMetadataUniversalIdentifier: targetObject, relationTargetFieldMetadataUniversalIdentifier: targetField });
    }
  });
  it('links canonical path index and field', () => {
    expect(result.allFlatEntityMaps.flatIndexMaps.byUniversalIdentifier['b75fa72e-7365-4da0-a910-b6ef96f306c2']).toMatchObject({ objectMetadataUniversalIdentifier: '6a8289d7-8034-4f70-b3fa-47bc0e52828f', indexFieldMetadata: [{ universalIdentifier: '30cf8266-372a-44b7-bdf5-f1188b168d6a', fieldMetadataUniversalIdentifier: '4452d201-44a5-46fc-bf11-e26fa85cc3b2' }] });
  });
});
