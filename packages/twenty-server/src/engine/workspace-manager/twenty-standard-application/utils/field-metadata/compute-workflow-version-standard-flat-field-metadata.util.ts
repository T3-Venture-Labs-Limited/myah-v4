...
> => ({
  ...
  campaignSequence: createStandardFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      fieldName: 'campaignSequence',
      type: FieldMetadataType.RAW_JSON,
      label: i18nLabel(msg`Campaign sequence`),
      description: i18nLabel(msg`Restricted Campaign outreach sequence`),
      icon: 'IconList',
      isSystem: true,
      isNullable: true,
      isUIEditable: false,
