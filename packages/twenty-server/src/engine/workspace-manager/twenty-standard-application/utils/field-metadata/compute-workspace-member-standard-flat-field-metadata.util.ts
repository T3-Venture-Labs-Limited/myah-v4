...
> => ({
  ...
  ownedCreators: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ownedCreators',
      label: i18nLabel(msg`Owned creators`),
      description: i18nLabel(msg`Creators owned by the workspace member`),
      icon: 'IconUserStar',
      isNullable: true,
      isUIEditable: false,
  ...
  ownedInboxThreads: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ownedInboxThreads',
      label: i18nLabel(msg`Owned inbox threads`),
      description: i18nLabel(msg`Inbox threads owned by the workspace member`),
      icon: 'IconMail',
      isNullable: true,
      isUIEditable: false,
      targetObjectName: 'messageThread',
      targetFieldName: 'inboxOwner',
      settings: {
        relationType: RelationType.ONE_TO_MANY,
      },
    },
  ...
  ownedCampaigns: createStandardRelationFieldFlatMetadata({
    objectName,
    workspaceId,
    context: {
      type: FieldMetadataType.RELATION,
      morphId: null,
      fieldName: 'ownedCampaigns',
      label: i18nLabel(msg`Owned campaigns`),
      description: i18nLabel(msg`Campaigns owned by the workspace member`),
      icon: 'IconTargetArrow',
      isNullable: true,
      isUIEditable: false,
