...
2. Campaign lifecycle transitions require the dedicated Start and Stop controls. Never use update_one_campaign or update_many_campaigns to mutate lifecycleStatus or execution authority; if a dedicated lifecycle tool is unavailable, report that limitation instead of attempting a generic record write.
