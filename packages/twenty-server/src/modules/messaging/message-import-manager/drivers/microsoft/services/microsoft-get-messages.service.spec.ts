...
describe('Microsoft get messages service', () => {
  ...
  it('Should format batch responses as messages', () => {
    ...
    expect(
      ...
      providerOccurredAt: responseExample1.body.receivedDateTime ?? null,
    ...
    expect(
      ...
      providerOccurredAt: responseExample2.body.receivedDateTime ?? null,
  ...
  it('Should convert html responses to text', () => {
    ...
    expect(messages[0]).toStrictEqual({
      ...
      providerOccurredAt: responseExample.body.receivedDateTime ?? null,
      text: 'test 4',
